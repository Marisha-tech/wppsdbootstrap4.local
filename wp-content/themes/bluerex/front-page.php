...
<header class="main-header">
    ...
    <div class="main-header-text">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda corporis nostrum optio quia reiciendis?
            Maxime!</p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 footer-images">
                <div class="row">
                    <div class="col-6"><img src="<?echo bloginfo(template_url);?>/assets/img/footer_1.png" alt=""></div>
                    <div class="col-6"><img src="<?echo bloginfo(template_url);?>/assets/img/footer_2.png" alt=""></div>
                    <div class="col-6"><img src="<?echo bloginfo(template_url);?>/assets/img/footer_3.png" alt=""></div>
                    <div class="col-6"><img src="<?echo bloginfo(template_url);?>/assets/img/footer_4.png" alt=""></div>
                </div>
            </div>
            <!-- /.col-md-6 -->
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">Terms of Us</a>
                    </li>
                    <li class="nav-item">
